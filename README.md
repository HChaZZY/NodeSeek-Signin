...
![GitHub stars](https://img.shields.io/github/stars/HChaZZY/NodeSeek-Signin?style=flat)
![Python](https://img.shields.io/badge/Language-Python-blue)
![License](https://img.shields.io/github/license/HChaZZY/NodeSeek-Signin)
...
此项目曾是[yowiv/NodeSeek-Signin](https://github.com/yowiv/NodeSeek-Signin)的一个分支，现已独立维护并持续更新。
